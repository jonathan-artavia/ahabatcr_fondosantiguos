...
namespace Fondos_Antiguos.Localization {
    ...
    public class SqlResource {
        ...
        ///FROM `aha`.`tblHistCatalogo`) ds WHERE {0}.
        /// </summary>
        ...
        ///FROM `aha`.`tblCatalogo`
        ///UNION
        ///SELECT ID, Descripcion as Contenido, Signatura, Fecha, Materias, NULL as IdSerie, Fichero, NULL as Libro, NULL as NumCaja, NULL as NumTomo, NULL as Folio, NULL as NumExpediente, NULL as NumCarpeta, Lugar, `Año`, `Mes`, Datos as `Observaciones`, `FechaCod`, 1 as `Hi [rest of string was truncated]&quot;;.
        /// </summary>
